...
function YoutubeFeb() {
    ...
    useEffect(() => {
        fetch(
            "https://youtube.googleapis.com/youtube/v3/search?part=id%2C%20snippet&channelId=UCE_M8A5yxnLfW0KghEeajjw&maxResults=10&order=date&key=AIzaSyDHSfymVmILlGsoo8lQM4FwCSGvLVacdMM"
            )
        .then((response) => {
